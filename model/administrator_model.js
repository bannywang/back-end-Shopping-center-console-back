...
async function update_login_status(account, status) {
    try {
        const query = 'UPDATE administrator_data SET login_status = ? WHERE account = ?'
...
async function update_login_time(account) {
    try {
        const query = 'UPDATE administrator_data SET login_time = CURRENT_TIMESTAMP WHERE account = ?'

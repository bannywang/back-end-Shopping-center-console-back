...
async function update_product_content(req, res) {
  ...
  try {
    if (id_card) {
      ...
      const update_result = await product.update_product_status_and_stock(
        id,
        product_status,
        size_stock,
        price
      ...
      if (update_result) {
        await product.update_product_status_and_stock(
          id,
          product_status,
          size_stock,
          price
...
async function add_new_product(req, res) {
  ...
  try {
    ...
    const add_product = await product.create_detail_and_product_data(
      brand,
      name,
      price,
      class_ification
